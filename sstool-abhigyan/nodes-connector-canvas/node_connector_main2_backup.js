window.addEventListener("load", () => {
	...
	const HANDLE_COLOR_INTUTION = "#1E1F4B";
...
//--------------CLASSES AND METHODS*----------------------------------------------------
	...
	startNode.createFirst(ctx);
	nodesArray.push(new Node(700, 70, 100, 70, false, false, false));
	nodesArray[nodesArray.length - 1].create(ctx);
	nodesArray.push(new Node(1000, 300, 100, 70, false, false, false));
	nodesArray[nodesArray.length - 1].create(ctx);
	nodesArray.push(new Node(1000, 70, 100, 70, false, false, false));
	nodesArray[nodesArray.length - 1].create(ctx);
	nodesArray.push(new Node(1000, 500, 100, 70, false, false, false));
	nodesArray[nodesArray.length - 1].create(ctx);
